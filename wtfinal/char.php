                            ...
                            <div class="album-all-songs">
                                ...
                                <div class="music-playlist">
                                    ...
                                    <div class="single-music active">
                                        ...
                                        <button style="background-color:  #bd177a; float: right;  border: none; padding: 5px 5px; text-align: center; text-decoration: none;  display: inline-block; font-size: 16px; margin: 4px 2px; cursor: pointer; font-family: sans-serif; font-weight: bold; border-radius: 4px;"type="button" value="jhon" class="shift" onclick="pushRules1('Jhon')" name="john">Add to playlist</button>
                                    </div>

                                    <!-- Single Song -->
                                    <div class="single-music">
                                    <button style="background-color:  #bd177a;   border: none; padding: 5px 5px; text-align: center; text-decoration: none;  display: inline-block; font-size: 16px; margin: 4px 2px; cursor: pointer; font-family: sans-serif; font-weight: bold; border-radius: 4px;"onclick="cs_change_music('audio/sofi.mp3'); my('Message to the Future')" id="preview" value="messa">Hey,mister Dj</button>
                        
                                        <button  style="background-color:  #bd177a; float: right;  border: none; padding: 5px 5px; text-align: center; text-decoration: none;  display: inline-block; font-size: 16px; margin: 4px 2px; cursor: pointer; font-family: sans-serif; font-weight: bold; border-radius: 4px;" type="button" value="jhon" class="shift" onclick="pushRules1('Bellie')">Add to playlist</button>
                                    </div>
                        ...
                        <div class="featured-album-content d-flex flex-wrap">
                            ...
                            <div class="album-songs h-100">
                                ...
                                <div class="artist-charts" >
                                    ...
                                    <h5 style="padding-top: -2px; ">Billie Eilish <button style="background-color:  #bd177a;   border: none; padding: 10px 5px; text-align: center; text-decoration: none;  display: inline-block; font-size: 16px; margin: 4px 2px; cursor: pointer; font-family: sans-serif; font-weight: bold; border-radius: 4px ; margin-left: 280px;"type=submit name="test1" class="like1" value="Ariana Grande" onclick="myFunction()" >Favourite</button></h5></div>
                                ...
                                <form method=post>
                                <div class="artist-charts">
                                    <h5>DJ Khaled <button style="background-color:  #bd177a;   border: none; padding: 10px 5px; text-align: center; text-decoration: none;  display: inline-block; font-size: 16px; margin: 4px 2px; cursor: pointer; font-family: sans-serif; font-weight: bold; border-radius: 4px; margin-left: 290px;"type=submit name="test1" class="like1" value="Ariana Grande" onclick="myFunction()" >Favourite</button></h5></div> 
                                </form>
